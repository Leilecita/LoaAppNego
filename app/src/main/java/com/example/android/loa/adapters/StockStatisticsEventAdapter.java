...
public class StockStatisticsEventAdapter  extends BaseAdapter<ReportStockEvent, StockStatisticsEventAdapter.ViewHolder> implements StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder> {
    private Context mContext;

    private String item_date = "";

    public StockStatisticsEventAdapter(Context context, List<ReportStockEvent> events) {
        setItems(events);
        mContext = context;

    }
    public StockStatisticsEventAdapter() {
    ...
    @Override
    public StockStatisticsEventAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // Create a new View
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_stock_event_day, parent, false);
        StockStatisticsEventAdapter.ViewHolder vh = new StockStatisticsEventAdapter.ViewHolder(v);

        return vh;
    }

    private void clearViewHolder(StockStatisticsEventAdapter.ViewHolder vh) {
    ...
    private void loadIcon(StockStatisticsEventAdapter.ViewHolder holder, final String item) {
    ...
    @Override
    public void onBindViewHolder(final StockStatisticsEventAdapter.ViewHolder holder, final int position) {
