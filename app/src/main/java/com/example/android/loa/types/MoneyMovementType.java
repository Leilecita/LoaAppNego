...
public enum MoneyMovementType {
    ...
    SANTI_PAGO_LOCAL(Constants.MONEY_SANTI_PAGO_LOCAL),
    SANTI_PAGO_ESCUELITA(Constants.MONEY_SANTI_PAGO_ESCUELITA),
    SANTI_PAGO_ARQUITECTURA(Constants.MONEY_SANTI_PAGO_ARQUITECTURA),
